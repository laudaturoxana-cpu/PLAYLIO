...
export const LIO_MESSAGES: Record<LioSituation, string[]> = {
  start: [
    ...
    'Această literă e super tare! Hai s-o găsim! 🌟',
  ],
  correct: [
    'Extraordinar! Ești fantastic! ⭐',
    'Corect! Ai nimerit din prima! 🎉',
    'Minunat! Mai vrei una? 🌈',
    'Super! Ești un adevărat erou al literelor! 🏆',
    'Perfect! Stele pentru tine! ✨',
  ],
  wrong_1: [
    'Hmm, mai încearcă! 🤔',
    'Nu asta — privește cu atenție! 👀',
    'Aproape! Încă o dată! 💪',
  ],
  wrong_2: [
    'Aproape! Uită-te la imagine! 🖼️',
    'Hai, poți! Litera e chiar acolo! 🎯',
    'Nu-ți face griji, privește atent! ❤️',
  ],
  wrong_3: [
    'Iată litera corectă! Să o privim împreună! 📚',
    'Să o privim cu atenție! 🔍',
    'Aceasta este litera! Să ne-o amintim! 💡',
  ],
  level_up: [
    'WOW! Ai trecut la nivelul următor! 🚀',
    'Devii din ce în ce mai bun! 🌟',
    'Un nivel nou! Ești un campion! 🏆',
  ],
  mastered: [
    'AI STĂPÂNIT ACEASTĂ LITERĂ! 🎓',
    'Felicitări! Această literă este a ta! ⭐⭐⭐',
